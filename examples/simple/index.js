(function(dependencies, chunks, undefined, global) {
    ...
    global["gbqN3LpB-Lgs3-4k1o-uNkq-eBgYZqc4kKa3v"] = function(asyncDependencies) {
        var i = -1,
...
/*@=-/var/www/html/node/_virt/virt-dom/examples/simple/src/index.js-=@*/
...
virt.getChildKey = require(24);
virt.getRootIdFromId = require(25);

virt.isAncestorIdOf = require(26);
virt.traverseAncestors = require(27);
virt.traverseDescendants = require(28);
virt.traverseTwoPhase = require(29);

virt.context = require(30);
virt.owner = require(31);
},
function(require, exports, module, undefined, global) {
/*@=-/var/www/html/node/_virt/virt-dom/src/index.js-=@*/
var renderString = require(76),
    nativeDOMComponents = require(77),
    nativeDOMHandlers = require(78);
...
virtDOM.render = require(79);
virtDOM.unmount = require(80);
...
virtDOM.findRoot = require(82);
virtDOM.findEventHandler = require(83);

virtDOM.createWorkerRender = require(84);
virtDOM.renderWorker = require(85);

virtDOM.createWebSocketRender = require(86);
virtDOM.renderWebSocket = require(87);
},
function(require, exports, module, undefined, global) {
...
var createPool = require(49),
    Queue = require(50),
    has = require(34),
    consts = require(23),
    InsertPatch = require(51),
    MountPatch = require(52),
    UnmountPatch = require(53),
    OrderPatch = require(54),
    PropsPatch = require(55),
    RemovePatch = require(56),
    ReplacePatch = require(57),
    TextPatch = require(58);
...
var virt = require(3),
    ...
    hyphenateStyleName = require(88),
    renderMarkup = require(89),
