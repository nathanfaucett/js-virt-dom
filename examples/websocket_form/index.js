...
virtDOM.findDOMNode = require(128);
...
nativeDOM.components = {
    ...
    textarea: {
        type: "textarea",
        constructor: require(125)
    },
    button: {
        type: "button",
        constructor: require(126)
    }
};
