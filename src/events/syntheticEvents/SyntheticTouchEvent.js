var getTouchEvent = require("../getters/getTouchEvent"),
    SyntheticUIEvent = require("./SyntheticUIEvent"),
    SyntheticTouch = require("./SyntheticTouch");
...
SyntheticTouchEventPrototype.getModifierState = require("../getters/getEventModifierState");
